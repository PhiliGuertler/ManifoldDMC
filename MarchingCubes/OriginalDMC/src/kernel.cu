...
int main()
{
    ...
    //dmc.init<unsigned short>("D:\\Dokumente(HDD)\\0_Dokumente\\Uni\\Master-Studium\\Semester11\\Masterarbeit\\git\\ma_guertler_dualmarchingcubes\\code\\data\\head_ushort_512_512_641.bin");
    //const float i0 = 30.0f;
    const float i0 = 0.0f;
