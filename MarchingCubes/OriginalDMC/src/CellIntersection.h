...
namespace p_mc {
    ...
    struct CellIntersection {
            ...
            float f[8], UGrid& ugrid, QuadrilateralHashTable& ht_, Vertices& v_)
        {
            ...
            //printf("Contour: %d, ContourSize: %llu\n", cnt_, c_);
            ...
            //for (int i = 0; i < 8; ++i) {
            //    printf("Normal %d: [%2.3f, %2.3f, %2.3f]\n", i, n[i].x, n[i].y, n[i].z);
            //}
            ...
            for (int t = 0; t < cnt_; t++)
            {
                ...
                //printf("Vertex: [%2.3f, %2.3f, %2.3f], Normal: [%2.3f, %2.3f, %2.3f]\n", ei.x, ei.y, ei.z, ni.x, ni.y, ni.z);
